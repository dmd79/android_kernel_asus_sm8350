...
extern void bat_get_hal_sensor_status(int); //ASUS_BSP ChiaYuan for balance mode
...
static void hall_sensor_report_function(struct work_struct *data)
{
	...
	//msleep(50);
	  ...
	  bat_get_hal_sensor_status(g_hall_data->status);//ASUS_BSP ChiaYuan for balance mode
